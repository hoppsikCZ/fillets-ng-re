...
ModelFactory::createUnit(const std::string &kind) {
    ...
    if ("fish_small" == kind) {
        ...
        extrafish.setUp(SDL_SCANCODE_UNKNOWN);
        extrafish.setDown(SDL_SCANCODE_UNKNOWN);
        extrafish.setLeft(SDL_SCANCODE_UNKNOWN);
        extrafish.setRight(SDL_SCANCODE_UNKNOWN);
